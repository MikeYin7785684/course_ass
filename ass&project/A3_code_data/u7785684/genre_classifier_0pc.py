...
def finetune_model(model, dataset_train, dataset_val=None, eval_model=None, batch_size=BATCH_SIZE, n_epochs=2, learning_rate=3e-5,fmodel='best_model.pth'):
    model.train(True)
...
if __name__=='__main__':
    ...
    train_size = 0.8
    train_dataset=df_tr.sample(frac=train_size,random_state=42)
